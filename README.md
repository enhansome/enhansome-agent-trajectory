...
1. **(NeurIPS Dataset\&Benchmark 2025) Why Do Multi-Agent LLM Systems Fail?** \[[Paper](https://arxiv.org/pdf/2503.13657)] [![GitHub Repo stars](https://img.shields.io/github/stars/multi-agent-systems-failure-taxonomy/MAST)](https://github.com/multi-agent-systems-failure-taxonomy/MAST) ⭐ 414 | 🐛 14 | 🌐 Python | 📅 2025-07-23
...
2. **(arXiv 2026) AgentRx: Diagnosing AI Agent Failures from Execution Trajectories** \[[Paper](https://arxiv.org/abs/2602.02475)] [![GitHub Repo stars](https://img.shields.io/github/stars/microsoft/AgentRx)](https://github.com/microsoft/AgentRx) ⭐ 145 | 🐛 17 | 🌐 Python | 📅 2026-06-22
...
3. **(ICLR 2026) AgenTracer: Who Is Inducing Failure in the LLM Agentic Systems?** \[[Paper](https://arxiv.org/abs/2509.03312)] [![GitHub Repo stars](https://img.shields.io/github/stars/bingreeky/AgenTracer)](https://github.com/bingreeky/AgenTracer) ⭐ 99 | 🐛 0 | 🌐 HTML | 📅 2026-08-27
...
4. **(ACL 2026) Seeing the Whole Elephant: A Benchmark for Failure Attribution in LLM-based Multi-Agent Systems** \[[Paper](https://aclanthology.org/2026.acl-long.912/)] [![GitHub Repo stars](https://img.shields.io/github/stars/TraceElephant/TraceElephant)](https://github.com/TraceElephant/TraceElephant) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2026-04-27
...
6. **(arXiv 2026) StepFinder: A Temporal Semantic Framework for Failure Attribution in Multi-Agent Systems** \[[Paper](https://arxiv.org/abs/2606.03467)] [![GitHub Repo stars](https://img.shields.io/github/stars/taiyu-zhu/StepFinder)](https://github.com/taiyu-zhu/StepFinder) ⭐ 4 | 🐛 2 | 🌐 Python | 📅 2026-05-28
...
1. **(arXiv 2026) AdaRubric: Task-Adaptive Rubrics for Reliable LLM Agent Evaluation and Reward Learning** \[[Paper](https://arxiv.org/abs/2603.21362)] [![GitHub Repo stars](https://img.shields.io/github/stars/alphadl/AdaRubrics)](https://github.com/alphadl/AdaRubrics) ⭐ 358 | 🐛 1 | 🌐 Python | 📅 2026-08-24
...
1. **(PACMI 2025) AgentSight: System-Level Observability for AI Agents Using eBPF** \[[Paper](https://arxiv.org/abs/2508.02736)] [![GitHub Repo stars](https://img.shields.io/github/stars/agent-sight/agentsight)](https://github.com/agent-sight/agentsight) ⭐ 663 | 🐛 26 | 🌐 C | 📅 2026-08-31
   \| Applies system-level telemetry to observe agent interactions with tools, processes, and runtime environments.
   `observability` `ebpf`

2. **(arXiv 2026) CodeTracer: Towards Traceable Agent States** \[[Paper](https://arxiv.org/abs/2604.11641)] [![GitHub Repo stars](https://img.shields.io/github/stars/NJU-LINK/CodeTracer)](https://github.com/NJU-LINK/CodeTracer) ⭐ 89 | 🐛 7 | 🌐 Python | 📅 2026-06-19
...
1. **TraceLab** \[[Paper](https://arxiv.org/abs/2606.30560)] \[[Dataset](https://github.com/uw-syfi/TraceLab#-the-dataset) ⭐ 109 | 🐛 6 | 🌐 Python | 📅 2026-08-22]
...
2. **RootSE Bench** \[[Paper](https://arxiv.org/abs/2605.26563)] \[[HuggingFace](https://huggingface.co/datasets/dengdan1999/RootSE)]
...
3. **AgentProcessBench** \[[Paper](https://arxiv.org/abs/2603.14465)] \[[HuggingFace](https://huggingface.co/datasets/LulaCola/AgentProcessBench)]
...
4. **CodeTraceBench** \[[Paper](https://arxiv.org/abs/2604.11641)] \[[HuggingFace](https://huggingface.co/datasets/NJU-LINK/CodeTraceBench)]
...
1. **ClawBench** \[[Paper](https://arxiv.org/abs/2604.08523)] \[[Code](https://github.com/reacher-z/ClawBench) ⭐ 639 | 🐛 59 | 🌐 Python | 📅 2026-09-01] \[[Data](https://huggingface.co/datasets/NAIL-Group/ClawBenchV1Trace)]
...
3. **AgentErrorBench** \[[Paper](https://arxiv.org/abs/2509.25370)] [![GitHub Repo stars](https://img.shields.io/github/stars/ulab-uiuc/AgentDebug)](https://github.com/ulab-uiuc/AgentDebug) ⭐ 103 | 🐛 4 | 🌐 Python | 📅 2026-03-30
